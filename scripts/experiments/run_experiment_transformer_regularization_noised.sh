...
### In this experiment, we try different dropout probabilities on the transformer layers (with permuted phrases)
# get dir
scripts_dir=`pwd`
...
if [[ $(basename "$VIRTUAL_ENV") == "$virtual_env_name" ]]; then
  ...
  do
    echo "ROUND $i \n\n"
    # dropout 0.15 with the 3 noise removed dataset (no noise)
    python3 train.py $DS_PATH/GeneratedData/LanguageTranslationMultimodalCSV/virtual/Annotations/train_no_noise.csv \
    --val-annotations $DS_PATH/GeneratedData/LanguageTranslationMultimodalCSV/virtual/Annotations/val.csv \
    --vocab $DS_PATH/GeneratedData/LanguageTranslationMultimodalCSV/virtual/Annotations/vocab.lst \
    ...
    --experiment-tag="NOISE_3_DROP_0.15" --comet-api-key="$COMET_API_KEY" --comet-project-name="ir_transformer_reg_exp" --comet-workspace="$COMET_WORKSPACE"

    # dropout 0.15 with the 2 noise removed dataset
    python3 train.py $DS_PATH/GeneratedData/LanguageTranslationMultimodalCSV/virtual/Annotations/train_one_noise.csv \
    --val-annotations $DS_PATH/GeneratedData/LanguageTranslationMultimodalCSV/virtual/Annotations/val.csv \
    --vocab $DS_PATH/GeneratedData/LanguageTranslationMultimodalCSV/virtual/Annotations/vocab.lst \
    --i-embedding-matrix $DS_PATH/GeneratedData/LanguageTranslationMultimodalCSV/virtual/Annotations/w2v_sg_source_50.npy \
    --o-embedding-matrix $DS_PATH/GeneratedData/LanguageTranslationMultimodalCSV/virtual/Annotations/w2v_sg_target_50.npy \
    --config $scripts_dir/transformer_regularization_config/config_drop_0.15.ini --batch-size=30 --steps=27000 --epochs=32 \
    --experiment-tag="NOISE_2_DROP_0.15" --comet-api-key="$COMET_API_KEY" --comet-project-name="ir_transformer_reg_exp" --comet-workspace="$COMET_WORKSPACE"

    # dropout 0.15 with the 1 noise removed dataset
    python3 train.py $DS_PATH/GeneratedData/LanguageTranslationMultimodalCSV/virtual/Annotations/train_two_noise.csv \
    --val-annotations $DS_PATH/GeneratedData/LanguageTranslationMultimodalCSV/virtual/Annotations/val.csv \
    --vocab $DS_PATH/GeneratedData/LanguageTranslationMultimodalCSV/virtual/Annotations/vocab.lst \
    --i-embedding-matrix $DS_PATH/GeneratedData/LanguageTranslationMultimodalCSV/virtual/Annotations/w2v_sg_source_50.npy \
    --o-embedding-matrix $DS_PATH/GeneratedData/LanguageTranslationMultimodalCSV/virtual/Annotations/w2v_sg_target_50.npy \
    --config $scripts_dir/transformer_regularization_config/config_drop_0.15.ini --batch-size=30 --steps=27000 --epochs=32 \
    --experiment-tag="NOISE_1_DROP_0.15" --comet-api-key="$COMET_API_KEY" --comet-project-name="ir_transformer_reg_exp" --comet-workspace="$COMET_WORKSPACE"

    # dropout 0.15 with the 3 noisy only dataset
    python3 train.py $DS_PATH/GeneratedData/LanguageTranslationMultimodalCSV/virtual/Annotations/train_noise_only.csv \
    --val-annotations $DS_PATH/GeneratedData/LanguageTranslationMultimodalCSV/virtual/Annotations/val.csv \
    --vocab $DS_PATH/GeneratedData/LanguageTranslationMultimodalCSV/virtual/Annotations/vocab.lst \
    --i-embedding-matrix $DS_PATH/GeneratedData/LanguageTranslationMultimodalCSV/virtual/Annotations/w2v_sg_source_50.npy \
    --o-embedding-matrix $DS_PATH/GeneratedData/LanguageTranslationMultimodalCSV/virtual/Annotations/w2v_sg_target_50.npy \
    --config $scripts_dir/transformer_regularization_config/config_drop_0.15.ini --batch-size=30 --steps=27000 --epochs=32 \
    --experiment-tag="NOISEONLY_DROP_0.15" --comet-api-key="$COMET_API_KEY" --comet-project-name="ir_transformer_reg_exp" --comet-workspace="$COMET_WORKSPACE"
  done
